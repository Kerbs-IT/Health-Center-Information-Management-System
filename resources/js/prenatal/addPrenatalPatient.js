...
prenatalAddBtn.addEventListener("click", async (e) => {
    ...
    const originalHTML = prenatalAddBtn.innerHTML;
    prenatalAddBtn.disabled = true;
    prenatalAddBtn.innerHTML = `
        <span class="spinner-border spinner-border-sm me-2" role="status" aria-hidden="true"></span>
        Submitting...
    `;

    const restoreBtn = () => {
        prenatalAddBtn.disabled = false;
        prenatalAddBtn.innerHTML = originalHTML;
    };
