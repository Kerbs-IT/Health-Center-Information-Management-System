...
export function addVaccineInteraction(btn, vaccineInput, vaccinesContainer, selectedVaccinesCon, selectedVaccines) {
     btn.addEventListener("click", (e) => {
         //  const vaccineInput = document.getElementById("vaccine_input");
         console.log("current selected vaccine:", selectedVaccines);
         const selectedText = vaccineInput.options[vaccineInput.selectedIndex].text;
         const selectedId = Number(vaccineInput.options[vaccineInput.selectedIndex].value);
