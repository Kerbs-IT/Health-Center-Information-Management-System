...
if (addMedicationBTN) {
    addMedicationBTN.addEventListener("click", (e) => {
        ...
        if (
            ...
            // reset the borders
            medicine.style.border = medicine.value === '' ? '1px solid red' : '';
            dosage_n_frequency.style.border =dosage_n_frequency.value === '' ? '1px solid red' : '';
            quantity.style.border = quantity.value === '' ? '1px solid red' : '';
            start_date.style.border = start_date.value === '' ? '1px solid red' : '';
            end_date.style.border = end_date.value === '' ? '1px solid red' : '';
        } else {
            Swal.fire({
...
// upload the data
const seniorCitizenBtn = document.getElementById('senior_citizen_save_record_btn');
