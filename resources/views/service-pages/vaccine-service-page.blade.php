    ...
    <div class="row g-4">
        <div class="col-lg-8">
            <div class="card info-card p-4">
                <h2 class="text-success fw-bold mb-3">Vaccine Name</h2>
                ...
                <h4 class="mt-4  text-success fw-bold">Dosage & Schedule</h4>
                ...
                <h4 class="mt-4 fw-bold text-success">Possible Side Effects</h4>
        ...
        <div class="col-lg-4">
            <div class="card p-4 info-card">
                <h5 class="fw-bold text-success">General Information</h5>
                <hr>

                <p class="mb-1 "><strong class="text-success">Category:</strong> Required Immunization</p>
                <p class="mb-1"><strong class="text-success">Age Group:</strong> Children / Adults</p>
                <p class="mb-1"><strong class="text-success">Availability:</strong> Available in Health Center</p>
            </div>
        </div>
    </div>
</div>
