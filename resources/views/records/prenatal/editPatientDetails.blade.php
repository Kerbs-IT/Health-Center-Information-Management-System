                                        ...
                                        <div class="mb-2 w-100 d-flex gap-2 flex-xl-nowrap flex-wrap">
                                            ...
                                            <div class="input-field flex-fill xl:w-[50%]">
                                                ...
                                                <select name="civil_status" id="civil_status" class="form-select bg-light border-dark">
                                                    ...
                                                    <option value="Single" {{ optional($prenatalRecord)->patient?->civil_status == 'Single' ? 'selected' : '' }}>Single</option>
                                                    <option value="Married" {{ optional($prenatalRecord)->patient?->civil_status == 'Married' ? 'selected' : '' }}>Married</option>
                                                    <option value="Divorce" {{ optional($prenatalRecord)->patient?->civil_status == 'Divorce' ? 'selected' : '' }}>Divorce</option>
                                                </select>
                                        ...
                                        <div class="current-prenancy w-100 d-flex gap-3 mb-3 border-bottom flex-lg-row flex-column">
                                            <div class="questions w-100" style="border:1px solid black;">
                                                ...
                                                <div class="mb-4 px-2 d-flex justify-content-between w-100">
                                                    ...
                                                    <div class="radio-input w-50 d-flex align-items-center justify-content-center gap-2">
                                                        <input type="radio" name="answer_1" value="yes" {{ optional($pregnancyHistory)->answer_1 == 'yes' ? 'checked' : '' }}>
                                                        <label for="yes">Oo</label>
                                                        <input type="radio" name="answer_1" value="no" {{ optional($pregnancyHistory)->answer_1 == 'no' ? 'checked' : '' }}>
                                                ...
                                                <div class="mb-4 px-2 d-flex justify-content-between w-100">
                                                    ...
                                                    <div class="radio-input w-50 d-flex align-items-center justify-content-center gap-2">
                                                        <input type="radio" name="answer_2" value="yes" {{ optional($pregnancyHistory)->answer_2 == 'yes' ? 'checked' : '' }}>
                                                        <label for="yes">Oo</label>
                                                        <input type="radio" name="answer_2" value="no" {{ optional($pregnancyHistory)->answer_2 == 'no' ? 'checked' : '' }}>
                                                        <label for="no">Hindi</label>
                                                    </div>
                                                </div>
                                                <div class="mb-4 px-2 d-flex justify-content-between w-100">
                                                    ...
                                                    <div class="radio-input w-50 d-flex align-items-center justify-content-center gap-2">
                                                        <input type="radio" name="answer_3" value="yes" {{ optional($pregnancyHistory)->answer_3 == 'yes' ? 'checked' : '' }}>
                                                        <label for="yes">Oo</label>
                                                        <input type="radio" name="answer_3" value="no" {{ optional($pregnancyHistory)->answer_3 == 'no' ? 'checked' : '' }}>
                                                        <label for="no">Hindi</label>
                                                    </div>
                                                </div>
                                                <div class="mb-2 px-2 d-flex justify-content-between w-100">
                                                    ...
                                                    <div class="radio-input w-50 d-flex align-items-center justify-content-center gap-2">
                                                        <input type="radio" name="answer_4" value="yes" {{ optional($pregnancyHistory)->answer_4 == 'yes' ? 'checked' : '' }}>
                                                        <label for="yes">Oo</label>
                                                        <input type="radio" name="answer_4" value="no" {{ optional($pregnancyHistory)->answer_4 == 'no' ? 'checked' : '' }}>
                                                        <label for="no">Hindi</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="questions w-100" style="border:1px solid black;">
                                                ...
                                                <div class="mb-4 px-2 d-flex justify-content-between w-100">
                                                    ...
                                                    <div class="radio-input w-50 d-flex align-items-center justify-content-center gap-2">
                                                        <input type="radio" name="q2_answer1" value="yes" {{ optional($pregnancyHistory)->q2_answer1 == 'yes' ? 'checked' : '' }}>
                                                        <label for="yes">Oo</label>
                                                        <input type="radio" name="q2_answer1" value="no" {{ optional($pregnancyHistory)->q2_answer1 == 'no' ? 'checked' : '' }}>
                                                        <label for="no">Hindi</label>
                                                    </div>
                                                </div>
                                                <div class="mb-4 px-2 d-flex justify-content-between w-100">
                                                    ...
                                                    <div class="radio-input w-50 d-flex align-items-center justify-content-center gap-2">
                                                        <input type="radio" name="q2_answer2" value="yes" {{ optional($pregnancyHistory)->q2_answer2 == 'yes' ? 'checked' : '' }}>
                                                        <label for="yes">Oo</label>
                                                        <input type="radio" name="q2_answer2" value="no" {{ optional($pregnancyHistory)->q2_answer2 == 'no' ? 'checked' : '' }}>
                                                        <label for="no">Hindi</label>
                                                    </div>
                                                </div>
                                                <div class="mb-4 px-2 d-flex justify-content-between w-100">
                                                    ...
                                                    <div class="radio-input w-50 d-flex align-items-center justify-content-center gap-2">
                                                        <input type="radio" name="q2_answer3" value="yes" {{ optional($pregnancyHistory)->q2_answer3 == 'yes' ? 'checked' : '' }}>
                                                        <label for="yes">Oo</label>
                                                        <input type="radio" name="q2_answer3" value="no" {{ optional($pregnancyHistory)->q2_answer3 == 'no' ? 'checked' : '' }}>
                                                        <label for="no">Hindi</label>
                                                    </div>
                                                </div>
                                                <div class="mb-4 px-2 d-flex justify-content-between w-100">
                                                    ...
                                                    <div class="radio-input w-50 d-flex align-items-center justify-content-center gap-2">
                                                        <input type="radio" name="q2_answer4" value="yes" {{ optional($pregnancyHistory)->q2_answer4 == 'yes' ? 'checked' : '' }}>
                                                        <label for="yes">Oo</label>
                                                        <input type="radio" name="q2_answer4" value="no" {{ optional($pregnancyHistory)->q2_answer4 == 'no' ? 'checked' : '' }}>
                                                        <label for="no">Hindi</label>
                                                    </div>
                                                </div>
                                                <div class="mb-4 px-2 d-flex justify-content-between w-100">
                                                    ...
                                                    <div class="radio-input w-50 d-flex align-items-center justify-content-center gap-2">
                                                        <input type="radio" name="q2_answer5" value="yes" {{ optional($pregnancyHistory)->q2_answer5 == 'yes' ? 'checked' : '' }}>
                                                        <label for="yes">Oo</label>
                                                        <input type="radio" name="q2_answer5" value="no" {{ optional($pregnancyHistory)->q2_answer5 == 'no' ? 'checked' : '' }}>
                                                        <label for="no">Hindi</label>
                                                    </div>
                                                </div>
                                            </div>
