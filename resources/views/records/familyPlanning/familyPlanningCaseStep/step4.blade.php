<div class="sexually-transmitted w-100 border-bottom align-self-center">
    ...
    <div class="sexually-transmitted-content">
        ...
        <div class="list-of-questions">
            ...
            <!-- follow up -->
            <div class="mb-md-2 mb-1 d-flex align-items-center justify-content-between" style="padding-left: 50px;">
                <div class="question d-flex align-items-center gap-3 w-[60%]">
                    <!-- <div class="small-box mb-0" style="height: 5px; width:5px; background-color:black"></div> -->
        ...
        <div class="reffered-to d-flex flex-column">
            ...
            <div class="list-of-org">
                <div class="type-of-user-inputs px-5">
                    ...
                    <!-- new clinic -->
                    <div class="mb-md-3 mb-1 d-flex align-items-center gap-2 flex-wrap flex-md-nowrap">
