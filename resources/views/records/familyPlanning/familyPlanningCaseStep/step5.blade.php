<div class="physical-examination w-100 ">
    ...
    <div class="signature d-flex justify-content-even w-100 gap-2 flex-lg-row flex-column">
        <div class="mb-md-3 mb-1 w-[100%] lg:w-[50%] d-flex flex-column">
        ...
        <div class="mb-md-3 mb-1 w-[100%] lg:w-[50%]">
    ...
    <div class="signature d-flex justify-content-even w-100 gap-2 border-bottom flex-lg-row flex-column">
        <div class="mb-md-3 mb-1 w-[100%] lg:w-[50%] d-flex flex-column">
