...
<div class="ackknowledgement ">
    ...
    <p class="px-2">
        ...
        choose the <u class="px-3" id="view_choosen_method">__________________</u> method.
    </p>
    ...
    <div class="row mb-3 px-2">
        ...
        <div class="col-md-6 d-flex flex-column">
            ...
            <div class="border p-3 text-center" id="view_date_of_acknowledgement"></div>
        </div>
    </div>
    ...
    <div class="row mb-3 border-bottom px-2">
        ...
        <div class="col-md-6 d-flex flex-column">
            <label class="fw-bold">Date:</label>
            <div class="border p-3 text-center" id="view_date_of_acknowledgement_consent"></div>
        </div>
    </div>
</div>