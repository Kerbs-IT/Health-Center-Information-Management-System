                    ...
                    <div class="flex-grow-1 py-3 px-lg-5 px-md-3 px-1">
                        ...
                        <form action="" method="POST" class="d-flex flex-column align-items-center  justify-content-center rounded overflow-hidden bg-white py-2" id="edit-tb-dots-patient-details-form">
                            ...
                            <div class="step d-flex flex-column w-100 rounded  px-2">
                                <div class="info">
                                    <h4>Personal Info</h4>
                                    <div class="mb-2 d-flex gap-1 flex-wrap flex-xl-row">
                                    ...
                                    <div class="mb-2 d-flex gap-1  flex-wrap flex-xl-nowrap">
                                        <!-- date of birth -->
                                        <div class="input-field lg:w-[50%] flex-fill">
                                    ...
                                    <div class="mb-2 d-flex gap-1 flex-wrap flex-xl-nowrap flex-column flex-md-row">
                                        <div class="input-field lg:w-[50%] flex-fill">
                                    ...
                                    <div class="mb-2 d-flex gap-1 flex-wrap flex-xl-nowrap flex-column flex-md-row">
                                        ...
                                        <!-- administered by -->
                                        <div class="mb-md-2 mb-0 lg:w-[50%] flex-fill">
                                        ...
                                        <div class="mb-md-2 mb-0 lg:w-[50%] flex-fill tb-dots-inputs d-flex flex-column">
                                    ...
                                    <div class="mb-2 d-flex gap-1 flex-column">
                                        <h4>Address</h4>
                                        <div class="input-field d-flex gap-2  w-100 flex-column flex-md-row">
                                            <div class=" mb-md-2 mb-0 lg:w-[50%] flex-fill">
                                    ...
                                    <div class="vital-sign w-100 border-bottom">
                                        ...
                                        <!-- 2nd row -->
                                        <div class="mb-md-2 mb-0 input-field d-flex gap-md-3 gap-1 w-100 second-row flex-wrap flex-xl-nowrap">
                                            <div class="mb-md-2 mb-0 lg:w-[50%] flex-fill">
                                            ...
                                            <div class="mb-md-2 mb-2 lg:w-[50%] flex-fill">
