        ...
        <div class="tb-dots card shadow p-4 w-100">
            <div class="table-responsive">
                <table class="table table-bordered">
                    <tbody>
                        <tr>
                            <th class="text-wrap">Patient Name</th>
                            <td id="view_patient_name"></td>
                        </tr>
                        <tr>
                            <th class="text-wrap">Type of Tuberculosis (TB)</th>
                            <td id="view_type_of_tuberculosis"></td>
                        </tr>
                        <tr>
                            <th class="text-wrap">Type of TB Case</th>
                            <td id="view_type_of_tb_case"></td>
                        </tr>
                        <tr>
                            <th class="text-wrap">Date of Diagnosis</th>
                            <td id="view_date_of_diagnosis"></td>
                        </tr>
                        <tr>
                            <th class="text-wrap">Name of Physician</th>
                            <td id="view_name_of_physician">Dr. Maria Santos</td>
                        </tr>
                        <tr>
                            <th class="text-wrap">Sputum Test Results</th>
