                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="actions d-flex gap-2 justify-content-center align-items-center">
                                            <a href=" {{route('record.tb-dots.view')}} ">
                                            ...
                                            <a href="{{ route('record.tb-dots.edit') }}" class="btn btn-info text-white fw-bold px-3">Edit</a>
                                            <a href="{{ route('record.tb-dots.case') }}" class="btn btn-dark text-white fw-bold px-3">Case</a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="actions d-flex gap-2 justify-content-center align-items-center">
                                            ...
                                            <a href="{{ route('record.family.planning.edit') }}" class="btn btn-info text-white fw-bold px-3">Edit</a>
                                            <a href="{{ route('record.family.planning.case') }}" class="btn btn-dark text-white fw-bold px-3">Case</a>
                                        </div>
                                    </td>
                                </tr>
