<div class="tb-dots card shadow p-md-4 p-2">
    <div class="mb-2 w-[100%] md:w-[50%] xl:w-[25%]">
        <label for="patient_name">Patient Name</label>
        <input type="text" class="form-control w-100 md:w-[50%] lg:w-[25%]" id="patient_name" name="patient_name" disabled value="{{$patient_name}}">
    </div>
    ...
    <div class="mb-2 d-flex gap-md-2 flex-wrap flex-md-nowrap">
    ...
    <h3>Medication</h3>
    <div class="mb-2 d-flex gap-md-2 w-100 ">
        <div class="mb-2 w-[100%] md:w-[50%] xl:w-[25%]">
        ...
        <div class="mb-2 d-flex gap-md-2 w-100 flex-wrap flex-xl-nowrap flex-md-row flex-column">
            <div class="mb-2 flex-fill xl:w-[50%]">
            ...
            <div class="mb-2 flex-fill xl:w-[50%]">
                ...
                <input type="date" class="form-control" id="edit_tb_end_date" min="{{date('Y-m-d')}}" max="{{date('Y-m-d',strtotime('+1 years'))}}">
            </div>
            <div class="mb2 d-flex flex-column">
                <label for="" class="text-white">edsfsdf</label>
