    ...
    <div class="card-body">
        ...
        <div class="final-switch-wrap mb-3" id="edit_final_toggle_section">
            <div class="switch-info">
                ...
                <small>Marks this as the patient's last TB-Dots check-up record. No further records can be added after saving.</small>
            </div>
        ...
        <div class="alert alert-danger d-flex align-items-center gap-2 py-2 mb-3 d-none" id="edit_is_final_warning">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" style="flex-shrink:0;">
                <path d="M8.982 1.566a1.13 1.13 0 0 0-1.96 0L.165 13.233c-.457.778.091 1.767.98 1.767h13.733c.889 0 1.438-.99.98-1.767L8.982 1.566zM8 5c.535 0 .954.462.9.995l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 5.995A.905.905 0 0 1 8 5zm.002 6a1 1 0 1 1 0 2 1 1 0 0 1 0-2z" />
            </svg>
            <small><strong>Warning:</strong> Once saved, this TB-Dots case will be <strong>closed</strong>. No new check-up records can be added.</small>
        </div>
