                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="actions d-flex gap-2 justify-content-center align-items-center">
                                            <a href=" {{route('record.senior.citizen.view')}} ">
                                            ...
                                            <a href="{{ route('record.senior.citizen.edit') }}" class="btn btn-info text-white fw-bold px-3">Edit</a>
                                            <a href="{{ route('record.senior.citizen.case') }}" class="btn btn-dark text-white fw-bold px-3">Case</a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="actions d-flex gap-2 justify-content-center align-items-center">
                                            ...
                                            <a href="{{ route('record.vaccination.edit') }}" class="btn btn-info text-white fw-bold px-3">Edit</a>
                                            <a href="{{ route('record.vaccination.case') }}" class="btn btn-dark text-white fw-bold px-3">Case</a>
                                        </div>
                                    </td>
                                </tr>
