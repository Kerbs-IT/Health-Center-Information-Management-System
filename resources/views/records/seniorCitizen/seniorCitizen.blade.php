                    ...
                    <div class="filters d-flex justify-content-lg-between justify-content-end flex-column flex-md-row">
                        ...
                        <div class="button-con d-flex align-items-center mt-1 justify-content-end">
                            ...
                            <div class="print d-flex align-items-center ms-2">
                                <svg xmlns="http://www.w3.org/2000/svg" class="print-icon w-10 h-10" viewBox="0 0 512 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="actions d-flex gap-2 justify-content-center align-items-center">
                                            <a href="/patient-record/senior-citizen/view-detail/{{$record->id}} ">
                                            ...
                                            <a href="/patient-record/senior-citizen/edit-details/{{$record->id}}" class="btn btn-info text-white fw-bold px-3">Edit</a>
                                            <a href="/patient-record/senior-citizen/view-case/{{$record->id}}" class="btn btn-dark text-white fw-bold px-3">Case</a>
                                        </div>
                                    </td>
                                </tr>
                                @empty
