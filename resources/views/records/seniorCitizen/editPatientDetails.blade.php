                                ...
                                <div class="info">
                                    ...
                                    <div class="mb-2 d-flex gap-1 flex-wrap flex-md-nowrap">
                                        <div class="input-field w-full md:w-[50%]">
                                            ...
                                            <input type="date" id="date_of_registration" placeholder="20" class="form-control text-center w-100 px-5 " name="date_of_registration" min="1950-01-01" max="{{date('Y-m-d')}}" value="{{ optional($seniorCitizenRecord)->date_of_registration?->format('Y-m-d') ?? '' }}">
                                    ...
                                    <div class="vital-sign w-100 border-bottom">
                                        ...
                                        <div class="mb-2 input-field d-flex gap-3 w-100 first-row flex-xl-nowrap flex-wrap flex-md-row flex-column">
                                            <div class="mb-2 flex-fill xl:w-[50%]">
                                                ...
                                                <input type="text" class="form-control w-100" placeholder="Enter the blood pressure" name="blood_pressure" id="blood_pressure" value="{{optional($seniorCitizenRecord -> senior_citizen_medical_record)->blood_pressure??''}}">
                                                <small class="text-danger error-text" id="blood_pressure_error"></small>
                                            </div>
                                            <div class="mb-2 flex-fill xl:w-[50%]">
                                                <label for="BP">Temperature(°C):</label>
                                                <input type="text" class="form-control w-100" placeholder="Enter the temperature" name="temperature" id="temperature" value="{{optional($seniorCitizenRecord -> senior_citizen_medical_record)->temperature??''}}">
                                                <small class="text-danger error-text" id="temperature_error"></small>
                                            </div>
                                            <div class="mb-2 flex-fill xl:w-[50%]">
                                                <label for="BP">Pulse Rate(Bpm):</label>
                                                <input type="text" class="form-control w-100" placeholder="Enter the  pulse rate" name="pulse_rate" id="pulse_rate" value="{{optional($seniorCitizenRecord -> senior_citizen_medical_record)->pulse_rate??''}}">
                                        ...
                                        <div class="mb-2 input-field d-flex gap-3 w-100 second-row flex-xl-nowrap flex-wrap flex-md-row flex-column">
                                            <div class="mb-2 flex-fill xl:w-[50%]">
                                                ...
                                                <input type="text" class="form-control w-100" placeholder="Enter the respiratory rate" name="respiratory_rate" id="respiratory_rate" value="{{optional($seniorCitizenRecord -> senior_citizen_medical_record)->respiratory_rate??''}}">
                                                <small class="text-danger error-text" id="respiratory_rate_error"></small>
                                            </div>
                                            <div class="mb-2 flex-fill xl:w-[50%]">
                                                <label for="BP">Height(cm):</label>
                                                <input type="text" class="form-control w-100" placeholder="Enter the height" name="height" id="height" value="{{optional($seniorCitizenRecord -> senior_citizen_medical_record)->height??''}}">
                                                <small class="text-danger error-text" id="height_error"></small>
                                            </div>
                                            <div class="mb-2 flex-fill xl:w-[50%]">
                                                <label for="BP">Weight(kg):</label>
                                                <input type="text" class="form-control w-100" placeholder="Enter the  weight" name="weight" id="weight" value="{{optional($seniorCitizenRecord -> senior_citizen_medical_record)->weight??''}}">
