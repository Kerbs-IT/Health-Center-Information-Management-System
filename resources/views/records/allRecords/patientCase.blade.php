...
<body >
    ...
    <div class="vaccination vh-100 d-flex">
        ...
        <div class="d-flex flex-grow-1 flex-shrink-1 flex-column overflow-x-auto">
            ...
            <main class="flex-column p-2">
                ...
                <div class="mb-3 w-100 px-lg-5 px-md-3 px-1">
                    ...
                    <div class="mb-2 filters d-flex justify-content-md-between justify-content-end flex-wrap flex-md-row flex-column">
                        ...
                        <div class="mb-md-3 mb-0 flex-fill">
                            <small>Search</small>
                            <input type="text" class="form-control bg-light" placeholder="Search the record num">
                        </div>
                        <div class="mb-md-3 mb-0 flex-fill">
                            <small>Filter</small>
    ...
    <div class="modal fade" id="patient_detail_modal" tabindex="-1" aria-labelledby="profileModalLabel" aria-hidden="">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="moda-body p-lg-5 p-md-3 px-1">
                    <div class="">
