        ...
        <div class="d-flex flex-grow-1 flex-column overflow-x-auto">
            ...
            <main class="flex-column p-2">
                ...
                <div class="mb-3 w-100 px-lg-5 px-md-3 px-1">
                    <div class="filters d-flex justify-content-lg-between justify-content-end mb-md-0 mb-2 flex-column flex-md-row">
                        ...
                        <div class="button-con d-flex align-items-center mt-1 justify-content-end">
                            ...
                            <div class="print d-flex align-items-center">
                                <label for="" class="text-white">1</label>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="actions d-flex gap-2 justify-content-center align-items-center">
                                            <a href=" {{route('record.allRecord.view')}} ">
                                            ...
                                            <a href="{{ route('allRecord.edit')}}" class="btn btn-info text-white fw-bold px-3">Edit</a>
                                            <a href="{{ route('record.allRecords.case')}}" class="btn btn-dark text-white fw-bold px-3">Case</a>
