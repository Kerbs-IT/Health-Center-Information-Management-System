        ...
        <div class="d-flex flex-grow-1 flex-column overflow-x-auto">
            ...
            <div class="d-flex flex-grow-1 flex-column">
                <main class="flex-column p-2">
                    ...
                    <!-- main content -->
                    <div class="flex-grow-1 py-3 px-md-3 px-lg-5 px-1 bg-white rounded">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-light">
                                <tbody>
                                    <tr>
                                        <td colspan="7" class="p-4 text-start text-wrap">Blk 25 lot 11, Green Forbes, Hugo Perez, Trece Martires City, Cavite, Philippines</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
