                ...
                <main class="flex-column p-2">
                    <div class="top-part d-flex justify-content-between px-2 align-items-center">
                        ...
                        <div class="sequence-links d-flex justify-content-center align-items-center">
                            <h5 class="mb-0 fw-normal d-none d-md-block">Records</h5>
                            <svg xmlns="http://www.w3.org/2000/svg" class="arrow-right d-none d-md-block" viewBox="0 0 320 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                                <path d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z" />
                            </svg>
                            <a href="#" class="text-decoration-none fs-5 d-none d-md-block">Vaccination</a>
                            <svg xmlns="http://www.w3.org/2000/svg" class="arrow-right d-none d-md-block" viewBox="0 0 320 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                                <path d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z" />
                            </svg>
                            <a href="#" class="text-decoration-none fs-5 text-black d-none d-md-block">View Patient</a>
                        </div>
                    </div>
                    <!-- main content -->
                    <div class="flex-grow-1 py-3 px-md-3 px-lg-5 px-1">
                        ...
                        <div class="info bg-white rounded ">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-light">
                                    <tbody>
                                        <tr>
                                            <td colspan="7" class="p-4 text-start text-wrap">{{$fullAddress?? 'none'}}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
