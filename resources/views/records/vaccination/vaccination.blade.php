        ...
        <div class="d-flex flex-grow-1 flex-column overflow-x-auto">
            ...
            <main class="flex-column p-2">
                ...
                <div class="mb-3 w-100 px-lg-5 px-md-3 px-1">
                    <div class="filters d-flex justify-content-lg-between justify-content-end flex-column flex-md-row">
                        <div class="mb-md-3 mb-0 flex-fill">
                            <small>Show Entries</small>
                            <input type="number" class="form-control bg-light" placeholder="10">
                        </div>
                        <div class="mb-md-3 mb-0 flex-fill">
                            <small>Search</small>
                        ...
                        <div class="button-con d-flex align-items-center mt-1 justify-content-end">
                            ...
                            <div class="print d-flex align-items-center ms-2">
                                <svg xmlns="http://www.w3.org/2000/svg" class="print-icon w-9 h-9" viewBox="0 0 512 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                        ...
                        <table class="w-100 table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ optional($record->patient)?->age ?? 'none' }}</td>
                                    <td>{{ optional($record->patient)?->sex ??'none' }}</td>
                                    <td>{{ optional($record->patient)?->contact_number}}</td>
                                    <td>{{optional($record->patient)?->created_at?->format('M j, Y')}}</td>
                                    <td>
                                        <div class="actions d-flex gap-2 justify-content-center align-items-center">
                                            ...
                                            <a href="" class="delete-record-icon" data-bs-patient-id="{{$record->patient->id}}">
