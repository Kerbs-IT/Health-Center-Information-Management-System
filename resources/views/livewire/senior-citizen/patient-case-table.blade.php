        ...
        <div class="table-responsive">
            <table class="w-100 table ">
                ...
                <tbody>
                    ...
                    <tr class="{{ $record->is_final ? 'table-secondary' : '' }}">
                        ...
                        <td>
                            <div class="actions d-flex gap-2 justify-content-center align-items-center">
                                ...
                                <button type="button" class="fs-3 text-success fw-bold editCaseBtn senior-citizen-edit-icon" data-bs-toggle="modal" data-bs-target="#editSeniorCitizenModal" data-bs-case-id="{{$record->id}}">
