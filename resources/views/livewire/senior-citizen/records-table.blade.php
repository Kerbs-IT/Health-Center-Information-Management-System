    ...
    <div class="mb-3 w-100 px-lg-5 px-md-3 px-2  min-h-[75vh]">
        ...
        <div class="alert alert-info d-flex justify-content-between align-items-center mb-3">
            ...
            <div>
                ...
                <button wire:click="clearFilter" class="btn btn-sm btn-outline-primary">
                    <i class="fa-solid fa-times"></i> Show All Senior Citizen Records
                </button>
            </div>
        </div>
        @endif
        <div class="filters d-flex justify-content-lg-between  justify-content-end  flex-wrap flex-xl-nowrap gap-3 mb-2 mb-md-0">
            ...
            <div class="button-con d-flex align-items-center mt-1 justify-content-end gap-1">
                ...
                <a href="{{route('record.archive')}}?type_of_case=senior-citizen" class="btn btn-danger">
                    ...
                    <tr class="{{ isset($record->checkup_status_info['class']) ? $record->checkup_status_info['class'] : '' }}">
                        ...
                        <td>
                            <div class="actions d-flex gap-2 justify-content-center align-items-center">
                                ...
                                @endphp
                                <a href="/patient-record/senior-citizen/view-detail/{{ $record->id }}?{{$backParams}}">
                                ...
                                <a href="/patient-record/senior-citizen/edit-details/{{ $record->id }}?{{$backParams}}" class="fs-2 text-success fw-bold ">
                                    <i class="fa-solid fa-pen-to-square"></i>
                                </a>
                                <a href="" class="delete-record-icon-seniorCitizen fs-2 " data-bs-patient-id="{{ $record->patient->id }}">
                                    <i class="fa-solid fa-box-archive text-danger"></i>
                                </a>

                                <a href="/patient-record/senior-citizen/view-case/{{ $record->id }}?{{$backParams}}" class="text-warning fw-bold fs-2">
