                    ...
                    <tr class="{{ isset($record->checkup_status_info['class']) ? $record->checkup_status_info['class'] : '' }}">
                        ...
                        <td>
                            <div class="actions d-flex gap-2 justify-content-center align-items-center">
                                ...
                                <a href="/patient-record/senior-citizen/edit-details/{{ $record->id }}" class="fs-2 text-success fw-bold ">
                                ...
                                <a href="/patient-record/senior-citizen/view-case/{{ $record->id }}" class="text-warning fw-bold fs-2">
