            ...
            <table class="w-100 table overflow-y-scroll">
                <thead class="table-header">
                    <tr class="text-nowrap">
                        ...
                        <th>Nurse</th>
                        <th style="cursor:pointer;" wire:click="sortBy('created_at')" class="text-nowrap">
                            Date
                    ...
                    <tr class="px-">
                        ...
                        <td>
                            <div class="actions d-flex gap-2 justify-content-center align-items-center">
                                ...
                                <button type="button" class="btn btn-info text-white fw-bold px-3 pregnancy_plan_edit_btn" data-bs-toggle="modal" data-bs-target="#case2PrenatalModal" id="pregnancy_plan_edit_btn" data-bs-id="{{$record['id']}}">Edit</button>
                                <button type="button" class="btn btn-danger pregnancy-plan-archive-record-icon text-white fw-bold px-3" data-case-id="{{$record['id']}}">Archive</button>
                                ...
                                <button type="button" class="btn btn-info text-white fw-bold px-3" data-bs-toggle="modal" data-bs-target="#editfamilyPlanningCaseModal" id="edit-family-plan-info" data-case-id="{{$record['id']}}">Edit</button>
                                <button type="button" class="btn btn-danger archive-family-plan-side-A text-white fw-bold px-3" data-case-id="{{$record['id']}}">Archive</button>
                                ...
                                <button type="button" class="btn btn-danger text-white fw-bold px-3 delete-side-b-record" data-case-id="{{$record['id']}}">Archive</button>
                                ...
                                <button type="button" class="btn btn-info text-white fw-bold px-3 editPregnancyCheckupBtn" data-bs-toggle="modal" data-bs-target="#checkUpModal" data-checkup-id="{{$record['id']}}">Edit</button>
                                <button type="button" class="btn btn-danger pregnancy-checkup-archieve-btn  text-white fw-bold px-3" data-case-id="{{$record['id']}}">Archive</button>
