                ...
                <tr class="{{ isset($record->followup_status_info['class']) ? $record->followup_status_info['class'] : '' }}">
                    ...
                    <td>
                        <div class="actions d-flex gap-2 justify-content-center align-items-center">
                            ...
                            <a href="/patient-record/family-planning/edit-details/{{ $record->id }}" class=" text-success fw-bold fs-3">
                            ...
                            <a href="/patient-record/family-planning/view-case/{{ $record->id }}" class=" text-warning fw-bold fs-3">
