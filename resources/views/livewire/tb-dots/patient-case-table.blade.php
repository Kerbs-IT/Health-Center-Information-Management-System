                ...
                <tr class="px-">
                    ...
                    <td>
                        <div class="actions d-flex gap-2 justify-content-center align-items-center">
                            ...
                            <button type="button" class="btn btn-danger text-white fw-bold px-3 archiveCaseBtn" data-case-id="{{$record->id}}">Archive</button>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="actions d-flex gap-2 justify-content-center align-items-center">
                            ...
                            <button type="button" class="btn btn-info text-white fw-bold px-3 edit-check-up tb-dots-edit-check-up" data-bs-toggle="modal" data-bs-target="#edit_tb_dots_checkup_Modal" data-case-id="{{$record->id}}">Edit</button>
                            <button type="button" class="btn btn-danger delete-record-icon text-white fw-bold px-3 tb-check-up-delete-btn" data-case-id="{{$record->id}}">Archive</button>
