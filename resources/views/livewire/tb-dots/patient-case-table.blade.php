        ...
        <div class="add-btn mb-3 d-flex justify-content-between">
            ...
            <div class="add-buttons d-flex justify-content-end text-nowrap flex-sm-row flex-column gap-2">
                ...
                <button
                    ...
                    title="This TB DOTS case is closed. The final check-up has already been recorded.">
                ...
                <button
                    type="button"
                    class="btn btn-success px-3 py-1"
                    data-bs-toggle="modal" data-bs-target="#tbDotsAddCheckUpModal" id="add-check-up-record-btn">
                    Add Check-up Record
                </button>
                @endif
