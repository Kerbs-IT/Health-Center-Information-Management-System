                    ...
                    <tr class="{{ isset($record->checkup_status_info['class']) ? $record->checkup_status_info['class'] : '' }}">
                        ...
                        <td>
                            <div class="actions d-flex gap-2 justify-content-center align-items-center">
                                ...
                                <a href="/patient-record/tb-dots/edit-details/{{ $record->id }}" class="text-success fw-bold fs-2">
                                ...
                                <a href="/patient-record/tb-dots/view-case/{{ $record->id }}" class="fs-2 text-warning fw-bold">
