                ...
                <tr class="px-">
                    ...
                    <td>
                        <div class="actions d-flex gap-2 justify-content-center align-items-center">
                            ...
                            <button type="button" class=" fs-3 text-success fw-bold  case-edit-btn" data-bs-toggle="modal" data-bs-target="#editVaccinationModal" data-bs-case-id="{{$record->id}}">
                                <i class="fa-solid fa-pen-to-square"></i>
                            </button>
                            <button type="button" class="fs-3 archive-record-icon text-danger fw-bold " data-bs-case-id="{{$record->id}}">
