    ...
    <div class="tables d-flex flex-column p-md-3 p-0">
        ...
        <div class="add-btn mb-3 d-flex justify-content-between">
            <div>
                ...
                'family-planning' => "/patient-record/family-planning/view-case/{$medicalRecordId}",
                'tb-dots' => "/patient-record/tb-dots/case/{$medicalRecordId}",
                'senior-citizen' => "/patient-record/senior-citizen/case/{$medicalRecordId}",
                ];

                $backUrl = url($backUrls[$section] ?? $backUrls['family-planning']);
                    ...
                    <tr class="px-">
                        ...
                        <td>
                            <div class="actions d-flex gap-2 justify-content-center align-items-center">
                                ...
                                <!-- <button type="button" data-bs-toggle="modal" data-bs-target="#viewdetailsModal" class="side-A-view-family-plan-info" data-case-id="{{$record['id']}}">
                                ...
                                <button onclick="confirmActivate({{ $record['id'] }}, 'family_planning_side_a')" class="text-success fs-2 fw-bold" title="Restore Record">
                                    <i class="fa-solid fa-rotate-left"></i>
                                </button>
                                <!-- <button type="button" wire:click="exportPdf({{$record['id']}},'a')">
                                ...
                                <button onclick="confirmActivate({{ $record['id'] }}, 'family_planning_side_b')" class="text-success fs-2 fw-bold" title="Restore Record">
                                    <i class="fa-solid fa-rotate-left"></i>
                                </button>
