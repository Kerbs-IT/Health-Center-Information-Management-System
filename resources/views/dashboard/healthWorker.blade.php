...
<body>
            ...
            <div class="modal-body">
                <form action="" method="post" class="d-flex gap-3 p-3 flex-wrap" enctype="multipart/form-data" id="profile-form">
                    ...
                    <div class="flex-fill">
                        ...
                        <!-- address -->
                        <div class="mb-2 d-flex gap-1 flex-column flex-wrap flex-fill">
                            <h4>Address</h4>
                    ...
                    <form action="" method="POST" id="add-health-worker-form" class="rounded shadow-none shadow-md-flex d-flex flex-column flex-wrap align-items-start align-items-md-center  p-0 p-md-4  w-sm-25 w-md-50 w-lg-25 bg-white">
                        ...
                        <div class="mb-3 w-100">
                            ...
                            <div class="input-pass d-flex align-items-center">
                                <input type="password" placeholder="Enter your password" name="password" class="py-2 px-2 w-100 responsive-input rounded form-control" id="add_password" autocomplete="off" value="{{old('password')}}">
                                <i class="fa-solid fa-eye p-3 bg-primary text-white toggle-eye" id="eye_icon"></i>
                            </div>
                            <small class="text-danger password-error"></small>
                        </div>
                        <!-- retype pass -->
                        <div class="mb-3 w-100">
                            <label for="re-type-pass" class="mb-1 font-weight-normal reponsive-label">Retype password:</label>
                            <div class="input-pass d-flex align-items-center position-relative">
                                <input type="password" placeholder="Re-type-password" name="password_confirmation" class="py-2 px-2 w-100 responsive-input rounded form-control" id="add_retype_pass">
                                <i class="fa-solid fa-eye p-3 bg-primary text-white toggle-eye" id="retype_eye_icon"></i>
                            </div>
                        ...
                        <div class="mb-3 w-95">
                            <input type="submit" value="Register Healthworker" class="d-block btn btn-success py-1 responsive-btn m-auto" id="add-Health-worker">
                        </div>
                    </form>
                </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const retypeInput = document.getElementById("add_retype_pass");
            const eyeIcon = document.getElementById("eye_icon");
            const retypeEyeIcon = document.getElementById("retype_eye_icon");
