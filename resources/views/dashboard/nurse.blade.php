                        ...
                        <div class="patient-today w-100 px-lg-4 px-md-3 px-2 d-flex gap-3 mb-3 flex-wrap">
                            ...
                            <div class="card shadow-sm mt-4 flex-fill overflow-hidden">
                                ...
                                <div class="card-body overflow-y-auto" style="max-height: 300px;">
                                    ...
                                    <!-- Vaccination -->
                                    <div class="service-item">
                                        <div class="service-label">Beverly Homes 1</div>
                                        <div class="service-count" style="background-color: #065A24;">12</div>
                                    </div>

                                    <!-- Prenatal -->
                                    <div class="service-item">
                                        <div class="service-label"> Beverly Homes 2</div>
                                        <div class="service-count" style="background-color:  #065A24;">10</div>
                                    </div>
                                    <div class="service-item">
                                        <div class="service-label"> Karlaville Park Homes</div>
                                        <div class="service-count" style="background-color:  #065A24;">10</div>
                                    </div>
                                    <div class="service-item">
                                        <div class="service-label"> Green Forbes City</div>
                                        <div class="service-count" style="background-color:  #065A24;">10</div>
                                    </div>
                                    <div class="service-item">
                                        <div class="service-label"> Gawad Kalinga</div>
                                        <div class="service-count" style="background-color:  #065A24;">10</div>
                                    </div>
                                    <div class="service-item">
                                        <div class="service-label"> Kaia Homes Phase 2</div>
                                        <div class="service-count" style="background-color:  #065A24;">10</div>
                                    </div>
                                    <div class="service-item">
                                        <div class="service-label"> Heneral Dos</div>
                                        <div class="service-count" style="background-color:  #065A24;">10</div>
                                    </div>
                                    <div class="service-item">
                                        <div class="service-label"> Purok 1</div>
                                        <div class="service-count" style="background-color:  #065A24;">10</div>
                                    </div>
                                    <div class="service-item">
                                        <div class="service-label"> Purok 2</div>
                                        <div class="service-count" style="background-color:  #065A24;">10</div>
                                    </div>
                                    <div class="service-item">
                                        <div class="service-label"> Purok 3</div>
                                        <div class="service-count" style="background-color:  #065A24;">10</div>
                                    </div>
                                    <div class="service-item">
                                        <div class="service-label"> Purok 4</div>
                                        <div class="service-count" style="background-color:  #065A24;">10</div>
                                    </div>
                                    <div class="service-item">
                                        <div class="service-label"> Purok 5</div>
                                        <div class="service-count" style="background-color:  #065A24;">10</div>
                                    </div>
                                    <div class="service-item">
                                        <div class="service-label"> Purok 6</div>
                                        <div class="service-count" style="background-color:  #065A24;">10</div>
                                    </div>
