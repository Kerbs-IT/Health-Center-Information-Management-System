...
<div class="menu-bar  min-vh-100">
    ...
    <div class="menu-bar-content d-flex flex-column align-items-center w-100">
        ...
        <div class="wrapper w-100 d-flex justify-content-center ">
            ...
            @endphp
            <a href="{{ route($routeName)}}" class="menu-option menu-items d-flex align-items-center gap-3 text-decoration-none text-white w-100 px-3 py-2" id="dashboard">
                <svg xmlns="http://www.w3.org/2000/svg" class=" icons home-icon" viewBox="0 0 576 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                    <path d="M575.8 255.5c0 18-15 32.1-32 32.1l-32 0 .7 160.2c0 2.7-.2 5.4-.5 8.1l0 16.2c0 22.1-17.9 40-40 40l-16 0c-1.1 0-2.2 0-3.3-.1c-1.4 .1-2.8 .1-4.2 .1L416 512l-24 0c-22.1 0-40-17.9-40-40l0-24 0-64c0-17.7-14.3-32-32-32l-64 0c-17.7 0-32 14.3-32 32l0 64 0 24c0 22.1-17.9 40-40 40l-24 0-31.9 0c-1.5 0-3-.1-4.5-.2c-1.2 .1-2.4 .2-3.6 .2l-16 0c-22.1 0-40-17.9-40-40l0-112c0-.9 0-1.9 .1-2.8l0-69.7-32 0c-18 0-32-14-32-32.1c0-9 3-17 10-24L266.4 8c7-7 15-8 22-8s15 2 21 7L564.8 231.5c8 7 12 15 11 24z" fill="white" />
                </svg>
        ...
        <!-- manage interface -->
        <div class="wrapper w-100 d-flex justify-content-center" id="manage_interface">
            <a href="{{route('manage.interface')}}" class="menu-option menu-items d-flex align-items-center gap-3 text-decoration-none text-white w-100 px-3 py-2" id="manage-interface">
                <svg xmlns="http://www.w3.org/2000/svg" class="icons " viewBox="0 0 512 512">
                    <path d="M448 160l-128 0 0-32 128 0 0 32zM48 64C21.5 64 0 85.5 0 112l0 64c0 26.5 21.5 48 48 48l416 0c26.5 0 48-21.5 48-48l0-64c0-26.5-21.5-48-48-48L48 64zM448 352l0 32-256 0 0-32 256 0zM48 288c-26.5 0-48 21.5-48 48l0 64c0 26.5 21.5 48 48 48l416 0c26.5 0 48-21.5 48-48l0-64c0-26.5-21.5-48-48-48L48 288z" fill="white" />
                </svg>
        ...
        <!-- Heatmap -->
        <div class="wrapper w-100 d-flex justify-content-center">
            <a href="#" class="menu-option menu-items d-flex align-items-center gap-3 text-decoration-none text-white w-100 px-3 py-2" id="heatmap">
                <svg xmlns="http://www.w3.org/2000/svg" class="icons map-icon" viewBox="0 0 576 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                    <path d="M408 120c0 54.6-73.1 151.9-105.2 192c-7.7 9.6-22 9.6-29.6 0C241.1 271.9 168 174.6 168 120C168 53.7 221.7 0 288 0s120 53.7 120 120zm8 80.4c3.5-6.9 6.7-13.8 9.6-20.6c.5-1.2 1-2.5 1.5-3.7l116-46.4C558.9 123.4 576 135 576 152l0 270.8c0 9.8-6 18.6-15.1 22.3L416 503l0-302.6zM137.6 138.3c2.4 14.1 7.2 28.3 12.8 41.5c2.9 6.8 6.1 13.7 9.6 20.6l0 251.4L32.9 502.7C17.1 509 0 497.4 0 480.4L0 209.6c0-9.8 6-18.6 15.1-22.3l122.6-49zM327.8 332c13.9-17.4 35.7-45.7 56.2-77l0 249.3L192 449.4 192 255c20.5 31.3 42.3 59.6 56.2 77c20.5 25.6 59.1 25.6 79.6 0zM288 152a40 40 0 1 0 0-80 40 40 0 1 0 0 80z" fill="white" />
                </svg>
        ...
        @if(Auth::user() -> role == 'nurse')
        <div class="wrapper w-100 d-flex justify-content-center">
            <a href="{{ route('health.worker') }}" class="menu-items menu-option d-flex align-items-center gap-3 text-decoration-none text-white w-100 px-3 py-2" id="healthWorker">
        ...
        <div class="wrapper w-100 d-flex justify-content-center">
            <a href="{{ route('manager.users') }}" class="menu-items menu-option d-flex align-items-center gap-3 text-decoration-none text-white w-100 px-3 py-2" id="manage_user">
                <svg xmlns="http://www.w3.org/2000/svg" class="icons" viewBox="0 0 448 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                    <path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512l388.6 0c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304l-91.4 0z" fill="white" />
                </svg>
        ...
        <div class="wrapper w-100 d-flex justify-content-center d-flex justify-content-center flex-column">
            <a href="{{ route('page.profile') }}" class="menu-items menu-option d-flex align-items-center gap-3 text-decoration-none text-white w-100 px-3 py-2" id="profile">
        ...
        <div class="wrapper w-100 d-flex justify-content-center flex-column">
            <a href="{{ route('add-patient')}}" class="menu-items menu-option d-flex align-items-center gap-3 text-decoration-none text-white  w-100 px-3 py-2" id="add-patient">
                <div class="d-flex align-items-center gap-3 ">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icons" viewBox="0 0 576 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                        <path d="M48 0C21.5 0 0 21.5 0 48L0 256l144 0c8.8 0 16 7.2 16 16s-7.2 16-16 16L0 288l0 64 144 0c8.8 0 16 7.2 16 16s-7.2 16-16 16L0 384l0 80c0 26.5 21.5 48 48 48l217.9 0c-6.3-10.2-9.9-22.2-9.9-35.1c0-46.9 25.8-87.8 64-109.2l0-95.9L320 48c0-26.5-21.5-48-48-48L48 0zM152 64l16 0c8.8 0 16 7.2 16 16l0 24 24 0c8.8 0 16 7.2 16 16l0 16c0 8.8-7.2 16-16 16l-24 0 0 24c0 8.8-7.2 16-16 16l-16 0c-8.8 0-16-7.2-16-16l0-24-24 0c-8.8 0-16-7.2-16-16l0-16c0-8.8 7.2-16 16-16l24 0 0-24c0-8.8 7.2-16 16-16zM512 272a80 80 0 1 0 -160 0 80 80 0 1 0 160 0zM288 477.1c0 19.3 15.6 34.9 34.9 34.9l218.2 0c19.3 0 34.9-15.6 34.9-34.9c0-51.4-41.7-93.1-93.1-93.1l-101.8 0c-51.4 0-93.1 41.7-93.1 93.1z" fill="white" />
                    </svg>
        ...
        <div class="wrapper w-100 d-flex justify-content-center flex-column">
            ...
            <div class="sub-menu  patient-menu w-75 align-self-end">
                <a href="{{ route('all.record')}}" class="menu-items d-flex  gap-3 text-decoration-none text-white w-100 px-3 py-2" id="record_all_records">
                ...
                <a href="{{ route('record.vaccination')}}" class="menu-items d-flex  gap-3 text-decoration-none text-white w-100 px-3 py-2" id="record_vaccination">
                ...
                <a href=" {{ route('records.prenatal') }}" class="menu-items d-flex  gap-3 text-decoration-none text-white w-100 px-3 py-2" id="record_prenatal">
                    <svg xmlns="http://www.w3.org/2000/svg" style="width: 20px;height:20px;" viewBox="0 0 384 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                        <path d="M192 0a48 48 0 1 1 0 96 48 48 0 1 1 0-96zM120 383c-13.8-3.6-24-16.1-24-31l0-55.1-4.6 7.6c-9.1 15.1-28.8 20-43.9 10.9s-20-28.8-10.9-43.9l58.3-97c15-24.9 40.3-41.5 68.7-45.6c4.1-.6 8.2-1 12.5-1l1.1 0 12.5 0 2.4 0c1.4 0 2.8 .1 4.1 .3c35.7 2.9 65.4 29.3 72.1 65l6.1 32.5c44.3 8.6 77.7 47.5 77.7 94.3l0 32c0 17.7-14.3 32-32 32l-16 0-40 0 0 96c0 17.7-14.3 32-32 32s-32-14.3-32-32l0-96-8 0-8 0 0 96c0 17.7-14.3 32-32 32s-32-14.3-32-32l0-97z" fill="white" />
                    </svg>
                    <h5 class="mb-0">Prenatal</h5>
                </a>
                <!-- senior citizen -->
                <a href="{{ route('record.senior.citizen')}}" class="menu-items d-flex gap-3 text-decoration-none text-white  w-100 px-3 py-2" id="record_senior_citizen">
                ...
                <!-- TB dots -->
                <a href=" {{ route('record.tb-dots')}}" class="menu-items d-flex gap-3 text-decoration-none text-white w-100 px-3 py-2" id="record_tb_dots">
        ...
        <!-- master list -->
        <div class="wrapper w-100 d-flex justify-content-center flex-column">
            <a href="#" class="menu-items d-flex align-items-center gap-3 text-decoration-none text-white menu-option w-100 px-3 py-2">
                <div class="menu-text d-flex align-items-center my-auto gap-3 ">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icons" viewBox="0 0 576 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                        <path d="M88.7 223.8L0 375.8 0 96C0 60.7 28.7 32 64 32l117.5 0c17 0 33.3 6.7 45.3 18.7l26.5 26.5c12 12 28.3 18.7 45.3 18.7L416 96c35.3 0 64 28.7 64 64l0 32-336 0c-22.8 0-43.8 12.1-55.3 31.8zm27.6 16.1C122.1 230 132.6 224 144 224l400 0c11.5 0 22 6.1 27.7 16.1s5.7 22.2-.1 32.1l-112 192C453.9 474 443.4 480 432 480L32 480c-11.5 0-22-6.1-27.7-16.1s-5.7-22.2 .1-32.1l112-192z" fill="white" />
                    </svg>
            ...
            <div class="sub-menu  patient-menu w-75 align-self-end">
                <a href="{{ route('masterlist.vaccination') }}" class="menu-items d-flex  gap-3 text-decoration-none text-white w-100 px-3 py-2" id="masterlist_vaccination">
                    <svg xmlns="http://www.w3.org/2000/svg" style="width: 20px;height:20px;" viewBox="0 0 512 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                        <path d="M441 7l32 32 32 32c9.4 9.4 9.4 24.6 0 33.9s-24.6 9.4-33.9 0l-15-15L417.9 128l55 55c9.4 9.4 9.4 24.6 0 33.9s-24.6 9.4-33.9 0l-72-72L295 73c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0l55 55L422.1 56 407 41c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0zM210.3 155.7l61.1-61.1c.3 .3 .6 .7 1 1l16 16 56 56 56 56 16 16c.3 .3 .6 .6 1 1l-191 191c-10.5 10.5-24.7 16.4-39.6 16.4l-88.8 0L41 505c-9.4 9.4-24.6 9.4-33.9 0s-9.4-24.6 0-33.9l57-57 0-88.8c0-14.9 5.9-29.1 16.4-39.6l43.3-43.3 57 57c6.2 6.2 16.4 6.2 22.6 0s6.2-16.4 0-22.6l-57-57 41.4-41.4 57 57c6.2 6.2 16.4 6.2 22.6 0s6.2-16.4 0-22.6l-57-57z" fill="white" />
                    </svg>
                    <h5 class="mb-0">Vaccination</h5>
                ...
                <!-- prenatal -->
                <!-- <a href="#" class="menu-items d-flex  gap-3 text-decoration-none text-white w-100 px-3 py-2">
                ...
                <!-- family planning -->
                <a href=" {{ route('masterlist.wra')}}" class="menu-items d-flex gap-3 text-decoration-none text-white w-100 px-3 py-2" id="masterlist_wra">
                    <svg xmlns="http://www.w3.org/2000/svg" style="width: 20px;height:20px;" viewBox="0 0 640 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                        <path d="M335.5 4l288 160c15.4 8.6 21 28.1 12.4 43.5s-28.1 21-43.5 12.4L320 68.6 47.5 220c-15.4 8.6-34.9 3-43.5-12.4s-3-34.9 12.4-43.5L304.5 4c9.7-5.4 21.4-5.4 31.1 0zM320 160a40 40 0 1 1 0 80 40 40 0 1 1 0-80zM144 256a40 40 0 1 1 0 80 40 40 0 1 1 0-80zm312 40a40 40 0 1 1 80 0 40 40 0 1 1 -80 0zM226.9 491.4L200 441.5l0 38.5c0 17.7-14.3 32-32 32l-48 0c-17.7 0-32-14.3-32-32l0-38.5L61.1 491.4c-6.3 11.7-20.8 16-32.5 9.8s-16-20.8-9.8-32.5l37.9-70.3c15.3-28.5 45.1-46.3 77.5-46.3l19.5 0c16.3 0 31.9 4.5 45.4 12.6l33.6-62.3c15.3-28.5 45.1-46.3 77.5-46.3l19.5 0c32.4 0 62.1 17.8 77.5 46.3l33.6 62.3c13.5-8.1 29.1-12.6 45.4-12.6l19.5 0c32.4 0 62.1 17.8 77.5 46.3l37.9 70.3c6.3 11.7 1.9 26.2-9.8 32.5s-26.2 1.9-32.5-9.8L552 441.5l0 38.5c0 17.7-14.3 32-32 32l-48 0c-17.7 0-32-14.3-32-32l0-38.5-26.9 49.9c-6.3 11.7-20.8 16-32.5 9.8s-16-20.8-9.8-32.5l36.3-67.5c-1.7-1.7-3.2-3.6-4.3-5.8L376 345.5l0 54.5c0 17.7-14.3 32-32 32l-48 0c-17.7 0-32-14.3-32-32l0-54.5-26.9 49.9c-1.2 2.2-2.6 4.1-4.3 5.8l36.3 67.5c6.3 11.7 1.9 26.2-9.8 32.5s-26.2 1.9-32.5-9.8z" fill="white" />
                    </svg>
        ...
        @if(Auth::user() -> role == 'patient')
        <a href="{{ route('dashboard.patient')}}" class="menu-option menu-items d-flex align-items-center gap-3 text-decoration-none text-white w-100 px-3 py-2" id="patient_dashboard">
            <svg xmlns="http://www.w3.org/2000/svg" class=" icons home-icon" viewBox="0 0 576 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                <path d="M575.8 255.5c0 18-15 32.1-32 32.1l-32 0 .7 160.2c0 2.7-.2 5.4-.5 8.1l0 16.2c0 22.1-17.9 40-40 40l-16 0c-1.1 0-2.2 0-3.3-.1c-1.4 .1-2.8 .1-4.2 .1L416 512l-24 0c-22.1 0-40-17.9-40-40l0-24 0-64c0-17.7-14.3-32-32-32l-64 0c-17.7 0-32 14.3-32 32l0 64 0 24c0 22.1-17.9 40-40 40l-24 0-31.9 0c-1.5 0-3-.1-4.5-.2c-1.2 .1-2.4 .2-3.6 .2l-16 0c-22.1 0-40-17.9-40-40l0-112c0-.9 0-1.9 .1-2.8l0-69.7-32 0c-18 0-32-14-32-32.1c0-9 3-17 10-24L266.4 8c7-7 15-8 22-8s15 2 21 7L564.8 231.5c8 7 12 15 11 24z" fill="white" />
            </svg>
            <h4 class="mb-0 fs-5">Dashboard</h4>
        </a>
        <a href="{{ route('view.medical.record')}}" class="menu-items menu-option d-flex align-items-center gap-3 text-decoration-none text-white w-100 px-3 py-2" id="patient_medical_record">
            <div class="menu-text d-flex align-items-center my-auto gap-3 ">
                <svg xmlns="http://www.w3.org/2000/svg" class="icons" viewBox="0 0 576 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                    <path d="M88.7 223.8L0 375.8 0 96C0 60.7 28.7 32 64 32l117.5 0c17 0 33.3 6.7 45.3 18.7l26.5 26.5c12 12 28.3 18.7 45.3 18.7L416 96c35.3 0 64 28.7 64 64l0 32-336 0c-22.8 0-43.8 12.1-55.3 31.8zm27.6 16.1C122.1 230 132.6 224 144 224l400 0c11.5 0 22 6.1 27.7 16.1s5.7 22.2-.1 32.1l-112 192C453.9 474 443.4 480 432 480L32 480c-11.5 0-22-6.1-27.7-16.1s-5.7-22.2 .1-32.1l112-192z" fill="white" />
                </svg>
        ...
        <!-- logout -->
        <div class="wrapper w-100 d-flex justify-content-center flex-column">
            <a href="" class="menu-items d-flex gap-3 text-decoration-none text-white w-100 px-3 py-2" id="logout-btn">
