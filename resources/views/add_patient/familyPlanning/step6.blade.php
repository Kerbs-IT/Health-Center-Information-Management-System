<div class="physical-examination w-[100%] xl:w-[75%] card shadow p-3 align-self-center d-flex">
    ...
    <div class="signature d-flex justify-content-even w-100 gap-2 flex-md-row flex-column">
        <div class="mb-md-3 mb-0 w-full md:w-[50%] d-flex flex-column">
        ...
        <div class="mb-md-3 mb-0 w-full md:w-[50%]">
    ...
    <div class="signature d-flex justify-content-even w-100 gap-md-2 gap-0 border-bottom flex-md-row flex-column mb-md-0 mb-2 pb-md-0 pb-2 flex-md-nowrap flex-wrap">
        <div class="mb-md-3 mb-0 w-full md:w-[50%]  d-flex flex-column">
