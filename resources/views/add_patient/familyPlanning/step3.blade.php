<div class="medical-history w-full xl:max-w-[960px] d-flex flex-column align-self-center card shadow p-3 h-100">
    <h4 class="border-bottom">I.MEDICAL HISTORY</h4>
    <h6>Does the client have any of the following?</h6>
    <div class="list-of-questions">
        <!-- q1 -->
        <div class="mb-2 d-flex align-items-start align-items-md-center justify-content-md-between flex-md-row flex-column">
            <div class="question d-flex align-items-center gap-3 flex-wrap">
                <div class="small-box mb-0 flex-fill" style="height: 5px; width:5px; background-color:black"></div>
                <p class="mb-0 fs-5 fw-light flex-fill">severe headaches/migraine</p>
            </div>
            <div class="answers d-flex align-items-center justify-content-center gap-2 align-self-center">
    ...
    <div class="buttons w-100 align-self-center d-flex justify-content-end gap-2 mt-auto">
        <button type="button" class="btn btn-danger px-3 px-md-5 py-2 fs-5" onclick="prevStep()">Back</button>
        <button type="button" class="btn btn-success px-3 px-md-5 py-2 fs-5" onclick="nextStep()">Next</button>
    </div>
</div>