            ...
            <tr>
                ...
                <td>
                    <div class="actions d-flex gap-2 justify-content-center align-items-center">
                        <button type="button" data-bs-toggle="modal" data-bs-target="#viewdetailsModal" class="senior-citizen-view-icon" data-bs-case-id="{{$record->id}}">
                        ...
                        <a href="{{ route('senior-citizen-case.pdf', ['caseId' => $record->id]) }}"
