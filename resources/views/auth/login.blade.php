                    ...
                    <form action="{{route('auth.login')}}" method="POST" class="rounded d-flex flex-column m-0 p-4 bg-white h-100">
                        ...
                        <div class="form-group  mb-2 w-100">
                            ...
                            <div class="input-pass d-flex align-items-center">
                                ...
                                <svg class="fa-solid fa-eye p-3 bg-primary text-white h-13 w-13" fill="white" id="eye-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><!--!Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2026 Fonticons, Inc.-->
