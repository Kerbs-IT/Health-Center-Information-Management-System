...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .banner .icon { font-size: 44px; margin-bottom: 8px; line-height: 1; }
        .banner h1 { font-size: 22px; margin-bottom: 4px; line-height: 1.3; }
        ...
        .chip-yellow { background: #fff8e1; color: #b7860b; }
        .chip-orange { background: #fff3e0; color: #c0540a; }
        .chip-gray   { background: #e8e8e8; color: #555555; }
        ...
        .section-header span { font-weight: normal; font-size: 12px; }
        .section-header-red    { background: #fde8e8; color: #c0392b; border-left: 4px solid #dc3545; }
        .section-header-yellow { background: #fff8e1; color: #856404; border-left: 4px solid #ffc107; }
        .section-header-orange { background: #fff3e0; color: #c0540a; border-left: 4px solid #fd7e14; }
        .section-header-gray   { background: #e8e8e8; color: #555555; border-left: 4px solid #6c757d; }
        ...
        .badge-orange { background: #fff3e0; color: #c0540a; }
        .badge-gray   { background: #e8e8e8; color: #555555; }
        ...
        .see-more a { color: #0a6b2c; font-weight: 600; text-decoration: none; }
        .empty-state {
            text-align: center;
            padding: 14px;
            color: #aaaaaa;
        ...
        .all-clear-box .all-clear-icon  { font-size: 36px; margin-bottom: 8px; }
        .all-clear-box .all-clear-title { color: #2e7d32; font-weight: bold; font-size: 16px; margin-bottom: 4px; }
        .all-clear-box .all-clear-sub   { color: #555555; font-size: 13px; }
        ...
        @media only screen and (max-width: 480px) {
            ...
            .logo-header { padding: 12px 14px; gap: 10px; flex-wrap: wrap; }
            .logo-header img { width: 40px; height: 40px; }
            .logo-text h4 { font-size: 11px;
                             }
            .logo-text h4:first-child { font-size: 12px; }
            ...
            .intro { font-size: 13px; padding: 10px 10px 10px 14px; }

            .window-badge { font-size: 12px; padding: 10px 12px; }

            /* Chips — shrink font/padding on small screens, still 1 row */
            .chip-table { border-spacing: 5px; }
            .chip-table td { padding: 12px 4px; }
            .chip-count { font-size: 20px; }
            .chip-label { font-size: 9px; letter-spacing: 0; margin-top: 4px; }
            ...
            .medicine-table th,
            .medicine-table td { padding: 8px 10px; font-size: 12px; }
        ...
        @media only screen and (max-width: 360px) {
            .chip-count { font-size: 16px; }
            .chip-label { font-size: 8px; }
            .chip-table td { padding: 10px 2px; }
