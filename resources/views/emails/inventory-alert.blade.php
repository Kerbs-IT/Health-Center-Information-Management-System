...
<head>
    ...
    <style>
        ...
        .email-logo-header { background: #ffffff; border-bottom: 3px solid #dc3545; padding: 16px 24px; border-radius: 8px 8px 0 0; margin: -30px -30px 0 -30px; display: flex; align-items: center; gap: 14px; }
        .email-logo-header img { width: 52px; height: 52px; object-fit: contain; flex-shrink: 0; }
        .email-logo-header .logo-text{
            margin-left: 10px;
        }
        .email-logo-header .logo-text h4 { margin: 0; font-size: 12px; font-weight: 600; color: #555; line-height: 1.4; }
        .email-logo-header .logo-text h4:first-child { color: #dc3545; font-size: 13px; }
        .header { background: #dc3545; color: white; padding: 20px; border-radius: 0; margin: 0 -30px 20px -30px; text-align: center; }
        .header h1 { margin: 0; font-size: 24px; }
        .icon { font-size: 48px; margin-bottom: 10px; }
        .alert-box-red    { background-color: #f8d7da; border-left: 4px solid #dc3545; padding: 15px; margin: 20px 0; border-radius: 4px; }
        .alert-box-yellow { background-color: #fff3cd; border-left: 4px solid #ffc107; padding: 15px; margin: 20px 0; border-radius: 4px; }
        .alert-box-orange { background-color: #ffe5d0; border-left: 4px solid #fd7e14; padding: 15px; margin: 20px 0; border-radius: 4px; }
        .alert-box-dark   { background-color: #e2e3e5; border-left: 4px solid #6c757d; padding: 15px; margin: 20px 0; border-radius: 4px; }
        .medicine-details { background-color: #f8f9fa; border-left: 4px solid #0a6b2c; padding: 15px; margin: 20px 0; border-radius: 4px; }
        .medicine-details p { margin: 8px 0; }
        .medicine-details strong { color: #0a6b2c; }
        .button { display: inline-block; padding: 12px 30px; background: #0a6b2c; color: white !important; text-decoration: none; border-radius: 5px; margin-top: 20px; font-weight: bold; }
...
<div class="email-container">
    ...
    {{-- Logo header (same pattern as appointment-reminder.blade.php) --}}
