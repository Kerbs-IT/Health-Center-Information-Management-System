...
<body>
    ...
    <h4 class="text-center fw-bold fs-2">VACCINATION CASE RECORD</h4>
    <div class="">
        <div class="card-body">
            ...
            <table class="table table-bordered">
                <tbody>
                    ...
                    <tr>
                        <th>Height</th>
                        <td id="view-height">{{$vaccinationCase->height}} cm</td> <!-- Replace with dynamic value -->
                    </tr>
                    <tr>
                        <th>Weight</th>
                        <td id="view-weight">{{$vaccinationCase->weight}} kg</td> <!-- Replace with dynamic value -->
                    </tr>
                    <tr>
                        <th>Temperature</th>
                        <td id="view-temperature">{{$vaccinationCase->patient_name}} °C</td> <!-- Replace with dynamic value -->
                    </tr>
                    <tr>
                        <th>Vaccine Type</th>
